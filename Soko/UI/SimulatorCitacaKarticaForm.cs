...
namespace Soko.UI
{
    public partial class SimulatorCitacaKarticaForm : Form
    {
        ...
        private void btnOcitajKarticu_Click(object sender, EventArgs e)
        {
            if (SelectedClan != null)
            {
                CitacKartica.getCitacKartica().handleDolazakNaTrening(SelectedClan.Broj.Value, dtpVremeOcitavanja.Value);
            }
        }

        private void SimulatorCitacaKarticaForm_Load(object sender, EventArgs e)
        {
