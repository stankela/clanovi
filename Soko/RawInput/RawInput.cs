...
namespace RawInput_dll
{
    public class RawInput : NativeWindow  
    {
        ...
        public static void GetDeviceNameAndVKey(IntPtr hdevice, out string deviceName, out int vkey)
        {
            _keyboardDriver.GetDeviceNameAndVKey(hdevice, out deviceName, out vkey);
        }
    }
}
